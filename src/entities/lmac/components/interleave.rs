...
mod tests {
    ...
    fn test_block_interleave_roundtrip() {
        ...
        interleaver::block_interleave(k, a, &data, &mut tmp);
        interleaver::block_deinterleave(k, a, &tmp, &mut out);
        assert_eq!(data, out);
    }
    ...
    fn test_matrix_interleave_roundtrip() {
        ...
        interleaver::matrix_interleave(lines, columns, &data, &mut tmp);
        interleaver::matrix_deinterleave(lines, columns, &tmp, &mut out);
        assert_eq!(data, out);
    }
}
