...
pub const CUB_BLK1_OFFSET: usize =       34+4;
pub const CUB_TRAINING_OFFSET: usize =   34+4+84;
pub const CUB_BLK2_OFFSET: usize =       34+4+84+30;
pub const CUB_TAILBITS_OFFSET: usize =   34+4+84+30+84;
...
pub const NUB_BLK1_OFFSET: usize =       34+4;
pub const NUB_TRAINING_OFFSET: usize =   34+4+216;
pub const NUB_BLK2_OFFSET: usize =       34+4+216+22;
pub const NUB_TAILBITS_OFFSET: usize =   34+4+216+22+216;
